...
class InternLMMLP(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.fc1 = nn.Linear(hidden_size, intermediate_size, bias=mlp_bias)
        self.act_fn = ACT2FN[hidden_act]
        self.fc2 = nn.Linear(intermediate_size, hidden_size, bias=mlp_bias)
...
INTERNLM_INPUTS_DOCSTRING = r"""
    Args:
        ...
        inputs_embeds (`torch.FloatTensor` of shape `(batch_size, sequence_length, hidden_size)`, *optional*):
            ...
            is useful if you want more control over how to model_hf `input_ids` indices into associated vectors than the
